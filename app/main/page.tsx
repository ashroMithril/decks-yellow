...
// Slide 0: Introduction Slide with Company Logos
const IntroductionSlide = () => (
  <div className="flex flex-col items-center justify-center h-full text-center px-8 relative overflow-hidden">
    ...
    >
      <div className="absolute top-20 left-20 w-80 h-80 bg-[#5A3BFE] rounded-full blur-3xl" />
      <div className="absolute bottom-20 right-20 w-80 h-80 bg-[#F8D57E] rounded-full blur-3xl" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-[#00A651] rounded-full blur-3xl opacity-30" />
    </motion.div>
    ...
    <motion.div
      ...
      className="mb-10"
    >
      <div className="inline-flex items-center bg-[#F8D57E] text-[#281C46] px-6 py-3 rounded-full shadow-md">
        <Calendar className="w-5 h-5 mr-3" />
        <span className="font-semibold text-lg">February 3, 2026</span>
      </div>
    </motion.div>
    ...
    <motion.div
      ...
      className="bg-white border-2 border-[#5A3BFE]/30 rounded-2xl px-10 py-6 shadow-lg"
    >
      <div className="flex items-center gap-6">
        <div className="w-20 h-20 bg-gradient-to-br from-[#5A3BFE] to-[#281C46] rounded-full flex items-center justify-center">
          <span className="text-white text-2xl font-bold">JG</span>
        </div>
        <div className="text-left">
          <h3 className="text-2xl font-bold text-[#281C46]">Jaya Kishore Gola Reddy</h3>
      ...
      {[
        ...
        >
          ...
          <div className="mt-3 flex items-center gap-2">
            ...
            <span className="text-xs text-[#281C46]/40 font-medium">DEMO</span>
          </div>
        </motion.div>
      ))}
    </motion.div>
          ...
          <div className="bg-white/8 rounded-xl p-4">
            <div className="flex items-center justify-between mb-3">
              <div className="text-center flex-1">
                ...
                <p className="text-white/50 text-xs">Salesforce, SAP</p>
              </div>
              <div className="flex flex-col items-center mx-3">
                <ArrowRight className="w-3.5 h-3.5 text-[#F8D57E]/70" />
                <span className="text-[#F8D57E]/80 text-xs my-0.5">Priming</span>
                <ArrowRight className="w-3.5 h-3.5 text-[#F8D57E]/70 rotate-180" />
                <span className="text-[#F8D57E]/80 text-xs mt-0.5">Write-back</span>
              </div>
              <div className="text-center flex-1">
                ...
                <p className="text-white/50 text-xs">User360 CDP</p>
              </div>
              <div className="flex flex-col items-center mx-3">
                <ArrowRight className="w-3.5 h-3.5 text-[#F8D57E]/70" />
              </div>
              <div className="text-center flex-1">
                ...
                <p className="text-white/50 text-xs">Context Window</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/8 rounded-xl p-4">
            <div className="flex items-center justify-center mb-4">
              <div className="text-center">
                ...
                <p className="text-white/50 text-xs">Traffic Controller</p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-50 rounded-xl p-4">
              ...
              <div className="flex items-center gap-1.5 mb-3">
                <div className="w-6 h-6 bg-gray-200 rounded flex items-center justify-center text-xs text-gray-500 font-medium">A</div>
                <ArrowRight className="w-3 h-3 text-gray-300" />
                <div className="w-6 h-6 bg-gray-200 rounded flex items-center justify-center text-xs text-gray-500 font-medium">B</div>
                <ArrowRight className="w-3 h-3 text-gray-300" />
                <div className="w-6 h-6 bg-gray-200 rounded flex items-center justify-center text-xs text-gray-500 font-medium">C</div>
              </div>
          ...
          <div className="bg-[#281C46]/10 rounded-xl p-3">
            ...
            <div className="flex items-center justify-between">
              <div className="text-center flex-1">
                ...
                <p className="text-[#281C46]/60 text-xs">Build backend integrations</p>
              </div>
              ...
              <div className="text-center flex-1">
                ...
                <p className="text-[#281C46]/60 text-xs">Arrange customer journey</p>
              </div>
            </div>
          </div>
        </motion.div>
    ...
    <div className="grid grid-cols-3 gap-4 flex-1">
      ...
      >
        ...
        <div className="mt-3 bg-white/10 rounded-lg p-2">
          <p className="text-[#F8D57E] text-xs font-semibold text-center">Like Cursor for code — but for enterprise agents</p>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="space-y-2.5">
          <div className="bg-[#5A3BFE]/5 rounded-lg p-2">
            ...
            <p className="text-[#281C46]/60 text-xs mt-1">Identify quick wins vs strategic investments</p>
          </div>
          <div className="bg-[#F8D57E]/20 rounded-lg p-2">
            ...
            <p className="text-[#281C46]/60 text-xs mt-1">Estimated deflection before building</p>
          </div>
          <div className="bg-[#5A3BFE]/5 rounded-lg p-2">
            <p className="text-[#281C46] text-xs font-semibold flex items-center gap-1.5">
            ...
            <p className="text-[#281C46]/60 text-xs mt-1">Based on ticket volume & complexity</p>
          </div>
        </div>
      </motion.div>
    </div>
    ...
    >
      ...
      <div className="grid grid-cols-4 gap-3">
        <div className="bg-[#281C46] rounded-xl p-3 text-center">
          ...
          <p className="text-white/60 text-xs mt-1">Tickets, logs, docs</p>
        </div>
        <div className="bg-[#281C46] rounded-xl p-3 text-center">
          <div className="bg-[#F8D57E] rounded-full w-6 h-6 flex items-center justify-center mx-auto mb-2">
          ...
          <p className="text-white/60 text-xs mt-1">Find automation opportunities</p>
        </div>
        <div className="bg-[#281C46] rounded-xl p-3 text-center">
          <div className="bg-[#F8D57E] rounded-full w-6 h-6 flex items-center justify-center mx-auto mb-2">
          ...
          <p className="text-white/60 text-xs mt-1">Prioritized use cases</p>
        </div>
        <div className="bg-[#281C46] rounded-xl p-3 text-center">
          <div className="bg-[#F8D57E] rounded-full w-6 h-6 flex items-center justify-center mx-auto mb-2">
          ...
          <p className="text-white/60 text-xs mt-1">Production-ready flows</p>
        </div>
      </div>
    </motion.div>
      ...
      <div className="flex flex-col gap-3">
        ...
        >
          ...
          <div className="space-y-1.5">
            <div className="bg-white/10 rounded-lg p-1.5">
              ...
              <p className="text-white/70 text-xs">RAG retrieval verification</p>
            </div>
            <div className="bg-white/10 rounded-lg p-1.5">
              <p className="text-[#F8D57E] text-xs font-semibold">Copilot Sessions</p>
              <p className="text-white/70 text-xs">Regression of known paths</p>
            </div>
            <div className="bg-white/10 rounded-lg p-1.5">
              <p className="text-[#F8D57E] text-xs font-semibold">Scenario Simulation</p>
              <p className="text-white/70 text-xs">Goal-based autonomous testing</p>
            </div>
            <div className="bg-white/10 rounded-lg p-1.5">
              <p className="text-[#F8D57E] text-xs font-semibold">Automated Regression</p>
              <p className="text-white/70 text-xs">Systemic stability checks</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="bg-[#281C46]/10 rounded-lg p-2">
            ...
            <p className="text-[#281C46]/60 text-xs">Prompt injection & guardrail testing</p>
          </div>
        </motion.div>
      </div>
        ...
        <div className="bg-[#281C46] rounded-2xl p-3 shadow-lg">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="bg-white/10 rounded-lg p-2 text-center">
              ...
              <p className="text-white/60 text-xs">Test cases recommended</p>
            </div>
            <div className="bg-white/10 rounded-lg p-2 text-center">
              <p className="text-[#F8D57E] text-lg font-bold">75</p>
              <p className="text-white/60 text-xs">Empathy score target</p>
            </div>
          </div>
        </div>
      </motion.div>
          ...
          <div className="space-y-1.5">
            {["Intent detection reasoning", "Tool selection logic", "KB chunks retrieved", "Response generation path"].map((item, index) => (
              <div key={item} className="flex items-center bg-gray-50 rounded-lg px-3 py-1.5">
                <span className="bg-[#5A3BFE] text-white text-xs font-bold w-4 h-4 rounded-full flex items-center justify-center mr-2 text-xs">{index + 1}</span>
    ...
    <div className="grid grid-cols-3 gap-5 max-w-6xl mx-auto w-full">
      ...
      >
        ...
        <div className="mt-3 pt-2 border-t border-[#281C46]/20">
          <p className="text-[#281C46]/60 text-xs font-medium mb-1.5">Upcoming</p>
          <div className="grid grid-cols-2 gap-2">
...
const SecuritySlide = () => (
  <div className="flex flex-col h-full px-12 py-6 justify-center">
    ...
    <motion.p
      ...
      animate={{ opacity: 1 }}
      transition={{ duration: 0.5, delay: 0.2 }}
      className="text-base text-[#281C46] mb-4"
    >
    ...
    <motion.div
      ...
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.5, delay: 0.3 }}
      className="bg-[#281C46] border border-[#281C46]/20 rounded-lg p-3 shadow-sm"
    >
      <h3 className="text-sm font-bold text-center mb-2 text-white">Security & Guardrails</h3>
      <div className="grid grid-cols-4 gap-3">
        {[
          { icon: Shield, title: "Enterprise Security", desc: "SOC 2 Type II, ISO 27001, ISO 27701 certified" },
          { icon: Lock, title: "Data Privacy", desc: "Data residency, PII masking, isolation" },
          { icon: FileKey, title: "Compliance", desc: "HIPAA, PCI-DSS compliant" },
          { icon: ShieldAlert, title: "Content Moderation", desc: "Real-time filtering & guardrails" },
        ].map((item, index) => (
          <motion.div
            key={item.title}
            initial={{ opacity: 0, scale: 0.9 }}
            ...
            className="bg-white backdrop-blur-sm border border-white/20 rounded-lg p-2 text-center shadow-sm"
          >
            <item.icon className="w-4 h-4 mx-auto mb-1 text-red-500" />
            <p className="text-xs font-medium text-red-700">{item.title}</p>
            <p className="text-xs text-[#281C46] mt-1">{item.desc}</p>
          </motion.div>
        ))}
      </div>
    </motion.div>
...
const sections = [
  { name: "Introduction", startSlide: 0, endSlide: 0, allocatedMinutes: 2 },
  { name: "Welcome", startSlide: 1, endSlide: 2, allocatedMinutes: 2 },
  { name: "Strategy & Overview", startSlide: 3, endSlide: 10, allocatedMinutes: 30 },
  { name: "Platform Architecture", startSlide: 11, endSlide: 12, allocatedMinutes: 30 },
  { name: "Customer Experience", startSlide: 13, endSlide: 16, allocatedMinutes: 30 },
  { name: "Admin/Developer Experience", startSlide: 17, endSlide: 28, allocatedMinutes: 90 },
  { name: "Customer Experience Demo", startSlide: 29, endSlide: 33, allocatedMinutes: 30 },
  { name: "Admin/Developer Demo", startSlide: 34, endSlide: 35, allocatedMinutes: 90 },
  { name: "Closing", startSlide: 36, endSlide: 36, allocatedMinutes: 5 },
]
        ...
        <div className="flex items-center gap-3">
          ...
          <div className={`flex items-center gap-2 px-3 py-1.5 rounded-lg ${isOverTime ? 'bg-red-50 border border-red-200' : 'bg-[#5A3BFE]/5'}`}>
            <div className="flex flex-col items-end mr-2">
              <span className="text-xs text-gray-500 leading-tight">{currentSection.name}</span>
              <span className="text-xs text-gray-400 leading-tight">{currentSection.allocatedMinutes} min allocated</span>
            </div>
