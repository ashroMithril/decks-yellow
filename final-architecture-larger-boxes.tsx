...
export default function FinalArchitectureLargerBoxes() {
  return (
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-12 gap-3 mb-3">
          ...
          <div className="col-span-8">
            {/* Automate & Analyse - LARGER */}
            <div className="grid grid-cols-2 gap-3 mb-3">
              {/* Automate Section */}
              <div className="bg-gradient-to-br from-amber-800/30 to-yellow-800/30 border border-amber-700/50 rounded-lg p-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <LargerFeatureCard icon={Bot} title="AI Copilot" description="for debugging" />
                  <LargerFeatureCard icon={Workflow} title="AI Agent Builder" description="dynamic conversations" />
                  <LargerFeatureCard icon={Cpu} title="Agentic Workflows" description="API automations" />
                  <LargerFeatureCard icon={Layers} title="Agent Marketplace" description="templates" />
                </div>
              </div>

              {/* Analyse Section */}
              <div className="bg-gradient-to-br from-green-800/30 to-emerald-800/30 border border-green-700/50 rounded-lg p-3">
                <div className="flex items-center justify-center mb-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <LargerFeatureCard icon={PieChart} title="Quantitative" description="analytics" />
                  <LargerFeatureCard icon={Activity} title="Qualitative" description="insights" />
                  <LargerFeatureCard icon={RefreshCw} title="Self Learning" description="KB/Flow" />
                  <LargerFeatureCard icon={Gauge} title="Custom" description="dashboards" />
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3 mb-3">
              ...
              <MiniAdditionalCard icon={Headphones} title="Human Helpdesk + Agent Assist" color="bg-blue-900/30" />
            </div>

            {/* Voice AI Features - Moved Below */}
            <div className="bg-gradient-to-r from-indigo-900/30 to-purple-900/30 border border-indigo-700/50 rounded-lg p-2">
