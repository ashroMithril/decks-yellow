...
export default function FinalArchitectureWithSecurity() {
  ...
  useEffect(() => {
    ...
    const timer3 = setTimeout(() => setAnimationStage(3), 2400) // Additional Features
    ...
    const timer8 = setTimeout(() => setAnimationStage(8), 5400) // Security & Guardrails
    const timer9 = setTimeout(() => setAnimationStage(9), 6000) // Foundation
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-950 via-indigo-950 to-purple-950 text-white p-4">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Enterprise Grade Agents - Renamed and moved in animation sequence */}
        <div
          className={`bg-gradient-to-r from-blue-900/30 to-cyan-900/30 border border-blue-700/50 rounded-lg p-2 mb-3 transition-all duration-700 ${animationStage >= 7 ? "opacity-100 transform translate-y-0" : "opacity-0 transform -translate-y-8"}`}
        >
          <h3 className="text-sm font-bold text-center mb-2 text-blue-300">Enterprise Grade Agents</h3>
        ...
        <div className="grid grid-cols-12 gap-3 mb-3">
          ...
          <div className="col-span-8">
            ...
            <div className="grid grid-cols-2 gap-3 mb-3">
              {/* Automate Section */}
              <div
                className={`bg-gradient-to-br from-amber-800/30 to-yellow-800/30 border border-amber-700/50 rounded-lg p-3 transition-all duration-700 ${animationStage >= 2 ? "opacity-100 transform scale-100" : "opacity-0 transform scale-95"}`}
              ...
              {/* Analyse Section */}
              <div
                className={`bg-gradient-to-br from-green-800/30 to-emerald-800/30 border border-green-700/50 rounded-lg p-3 transition-all duration-700 ${animationStage >= 2 ? "opacity-100 transform scale-100" : "opacity-0 transform scale-95"}`}
            ...
            {/* Additional Features */}
            <div
              className={`grid grid-cols-3 gap-3 mb-3 transition-all duration-700 ${animationStage >= 3 ? "opacity-100 transform translate-y-0" : "opacity-0 transform translate-y-8"}`}
            >
              {[
            ...
            {/* Voice AI Features */}
            <div
              className={`bg-gradient-to-r from-indigo-900/30 to-purple-900/30 border border-indigo-700/50 rounded-lg p-2 transition-all duration-700 ${animationStage >= 4 ? "opacity-100 transform translate-y-0" : "opacity-0 transform translate-y-8"}`}
            >
        ...
        {/* Security and Guardrails - NEW SECTION */}
        <div
          className={`bg-gradient-to-r from-red-900/30 to-orange-900/30 border border-red-700/50 rounded-lg p-2 mb-3 transition-all duration-700 ${animationStage >= 8 ? "opacity-100 transform translate-y-0" : "opacity-0 transform translate-y-8"}`}
        >
          <h3 className="text-sm font-bold text-center mb-2 text-red-300">Security & Guardrails</h3>
            ...
            {[
              ...
              <div
                ...
                style={{
                  ...
                  transform: animationStage >= 8 ? "translateY(0)" : "translateY(10px)",
                }}
                className="transition-all duration-500 bg-white/10 backdrop-blur-sm rounded-lg p-2 text-center"
              >
                <security.icon className="w-4 h-4 mx-auto mb-1 text-red-300" />
                <p className="text-xs">{security.title}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Foundation */}
        <div
          className={`bg-gradient-to-r from-indigo-900/30 to-blue-900/30 border border-indigo-700/50 rounded-lg p-2 text-center mb-2 transition-all duration-700 ${animationStage >= 9 ? "opacity-100 transform translate-y-0" : "opacity-0 transform translate-y-8"}`}
        >
